...
const login = async (credentials) => {
	try {
		...
		console.log('signup / login success! go to che chat window');
		showChat();
	} catch (err) {
		showLogin(err);
	}
...
<main class="login container">
	<div class="row">
		<div class="col-12 col-6-tablet push-3-tablet text-center header">
				...
				<div class="message-wrapper">
					<p class="message-header">
						...
						<span class="sent-date font-300">
							${moment(message.createdAt).local().format('Do MMM, hh:mm:ss')}
						</span>
					</p>
